...
//	NVIC_SetPriority(I2C1_ER_IRQn, 0);
  ...
  /*---------------------------- I2Cx CR1 Configuration ----------------------*/		
	...
	I2Cx->TIMINGR |= 40U;       //M SCLL: SCL low period (master mode) > 1.4 us
	I2Cx->TIMINGR |= 40U << 8;  // SCLH: SCL high period (master mode) > 1.4 us	 
	...
	// This is helpful if ST32 is used as slave
